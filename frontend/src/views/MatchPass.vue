      ...
      <div class="card-body items-center text-center">
        ...
        <div class="form-control w-full max-w-xs">
          ...
          <input
            ...
            class="input input-bordered input-secondary w-full max-w-xs text-lg mb-5"
            v-model="email"
            id="email"
          />
          <!-- <label class="label">
          ...
          <input
            ...
            placeholder="••••••••"
            v-model="password"
            class="input input-bordered input-secondary w-full max-w-xs text-2xl mb-7"
            id="password"
          />
          <input
            v-else
            type="text"
            v-model="password"
            class="input input-bordered input-secondary w-full max-w-xs text-lg mb-7"
            id="password"
          />
          <!-- <label class="label">
                        <span class="label-text-alt"></span>
          ...
          <div v-show="isChecked" class="mb-3">
            ...
            <div
              class="alert alert-success shadow-lg w-auto h-12 text-[16px] text-gray-50 self-center"
              v-else
            >
              <div>
                <svg
