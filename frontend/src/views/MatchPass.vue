    ...
    <div class="w-full h-full bg-gray-500/20 p-10 flex justify-center mt-10">
        <div class="card w-96 bg-base-100 shadow-xl">
            ...
            <div class="card-body items-center text-center">
                <h2 class="card-title text-2xl">Match Password</h2>
                ...
                <div class="form-control w-full max-w-xs">
                    ...
                    <input type="email" placeholder="example@mail.kmutt.ac.th"
                        class="input input-bordered input-secondary w-full max-w-xs text-lg mb-5" v-model="email"
                        id="email" />
                    <!-- <label class="label">
                    ...
                    <div v-show="isChecked" class="mb-3">
                        <div class="alert alert-error shadow-lg w-auto h-12 text-[16px] text-white self-center"
                            ...
                            <div v-if="isExist">
                                ...
                                <span class="ml-3">Password does not matched.</span>
                            </div>
                            <div v-else>
                                <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6"
                                    fill="none" viewBox="0 0 24 24">
                                ...
                                <span class="ml-9">Email does not exist.</span>
                            </div>
                        </div>
                        <div class="alert alert-success shadow-lg w-auto h-12 text-[16px] text-gray-50 self-center"
                            v-else>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6"
                                    fill="none" viewBox="0 0 24 24">
                ...
                <div class="card-actions">
                    <button class="btn btn-primary" @click="checkMatch">Check</button>
                </div>
            </div>
        </div>
